...
public class TreesCounterMapperTest extends TestCase {
    @Mock
    private Mapper.Context context;
    private TreesCounterMapper treesCounterMapper;

    @Before
    public void setup(){ this.treesCounterMapper = new TreesCounterMapper();}
    ...
    public void testMap() throws IOException, InterruptedException{
        ...
        this.treesCounterMapper.map(null, new Text(value), this.context);
