...
public class SpeciesListMapperTest extends TestCase {
    @Mock
    private Mapper.Context context;
    private SpeciesListMapper speciesListMapper;

    @Before
    public void setup(){
        this.speciesListMapper = new SpeciesListMapper();
    }
    ...
    public void testMap() throws IOException, InterruptedException{
        ...
        this.speciesListMapper.map(null, new Text(value), this.context);
